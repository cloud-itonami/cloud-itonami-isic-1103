# Operator Quickstart — Malt Liquor and Malt Manufacturing Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1103** (`cloud-itonami-isic-1103`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1103.git
cd cloud-itonami-isic-1103
```
...
- Blueprint governor key: `maltops-governor`
- Likely source path: `maltops.governor.cljc`
