(ns maltops.sim
  "Simulation driver for testing the malt-liquor (beer) and malt
  ...
  Example flow:
    ...
    3. Propose a batch -> :packaging transition with production parameters
    4. Governor validates parameters against facts
    5. If valid, audit fact is committed
    6. CLI prints audit trail")

(defn -main [& _args]
  (println "MaltOps simulation: not yet implemented.")
